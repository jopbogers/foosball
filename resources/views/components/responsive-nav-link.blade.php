...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-yellow text-start text-base font-medium text-indigo-300 bg-indigo-900/50 focus:outline-none focus:text-indigo-200 focus:bg-indigo-900 focus:border-indigo-300 transition duration-150 ease-in-out'
