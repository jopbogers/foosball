        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <div class="absolute z-50 mt-2 w-48 rounded-md shadow-lg bg-gray-700">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                        class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:hover:text-gray-400 hover:hover:bg-gray-900 focus:outline-none focus:focus:bg-gray-900 focus:focus:text-gray-400 transition duration-150 ease-in-out">
